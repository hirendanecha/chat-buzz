...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/chat-buzz/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(join(process.cwd(), 'dist/chat-buzz/browser'), 'index.html')
    )
    .toString();
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          description:
            ...
            `,
          image:
            'https://Chat.buzz/assets/images/meta-image.jpg',
          site: 'https://Chat.buzz/',
          url: 'https://Chat.buzz' + params,
          keywords: 'ChatBuzz, Buzz',
        };
